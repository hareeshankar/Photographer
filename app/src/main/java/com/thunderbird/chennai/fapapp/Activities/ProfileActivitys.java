...
import com.thunderbird.chennai.fapapp.Fragments.EventFragment;
...
import com.thunderbird.chennai.fapapp.Fragments.VideoFragment;
...
public class ProfileActivitys extends AppCompatActivity {
    ...
    public void getUserPhotosService() {
        ...
        asyncHttpClient.get(ProfileActivitys.this, url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (status == 1) {
                        ...
                        Glide.with(ProfileActivitys.this).load(Textclass.photos + jsonArray.getJSONObject(0).getString("photos")).diskCacheStrategy(DiskCacheStrategy.ALL).override(100, 100).centerCrop().placeholder(R.drawable.avtar).into(imgBlur);

                    } else if (status == 0) {
                     //   Toast.makeText(ProfileActivity.this, getString(R.string.no_data), Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(ProfileActivitys.this, getString(R.string.something_went_wrong), Toast.LENGTH_SHORT).show();
                    }
        ...
        if (hasBackKey || hasHomeKey) { // There's a navigation bar.
            resideMenu.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    resideMenu.setPadding(resideMenu.getPaddingLeft(), resideMenu.getPaddingTop(), resideMenu.getPaddingRight(), 0);
                }
            }, 300);
        }
...
//
        ...
        itemContactUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProfileActivitys.this, FeedbackActivity.class);
        ...
        itemSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivitys.this, PhotographerListActivity.class);
                startActivity(intent);
                finish();
                resideMenu.closeMenu();
            }
        ...
        itemFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ProfileActivitys.this, FilterActivity.class);
                startActivity(intent);
                finish();
                resideMenu.closeMenu();
            }
        ...
        itemInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivitys.this, InfoActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        itemTAndC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ProfileActivitys.this, TandCActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        itemExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ProfileActivitys.this).setMessage("Are you sure you want to logout?").setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        editor.clear();
                        editor.commit();
                        Intent intent = new Intent(ProfileActivitys.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
    ...
    public void showEditDialog() {
        ...
        ArrayAdapter<String> adapterCity=new ArrayAdapter<String>(ProfileActivitys.this,android.R.layout.simple_spinner_dropdown_item,citiesList);
        ...
        spCity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int pos, long l) {
                ...
                if(spCity.getSelectedItemPosition()!=0) {
                    ...
                    ArrayAdapter<String> adapterArea = new ArrayAdapter<String>(ProfileActivitys.this, android.R.layout.simple_spinner_dropdown_item, areaNameList);
        ...
        ArrayAdapter<String> adapterCountry = new ArrayAdapter<String>(ProfileActivitys.this, android.R.layout.simple_spinner_dropdown_item, countryList);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(ProfileActivitys.this, android.R.layout.simple_spinner_dropdown_item, stateList);
            ...
            public void onClick(View view) {
                ...
                if (utility.isNetworkAvailable()) {
                    if (edtFirstName.getText().toString().equalsIgnoreCase("")) {
                        Toast.makeText(ProfileActivitys.this, "Enter first name", Toast.LENGTH_SHORT).show();
                    } else if (tvLastName.getText().toString().equalsIgnoreCase("")) {
                        Toast.makeText(ProfileActivitys.this, "Enter last name", Toast.LENGTH_SHORT).show();
                    } else if (tvPhoneName.getText().toString().equalsIgnoreCase("")) {
                        Toast.makeText(ProfileActivitys.this, "Enter phone", Toast.LENGTH_SHORT).show();
                    } else if (tvPhoneName.getText().toString().length() != 10) {
                        Toast.makeText(ProfileActivitys.this, "Enter valid phone number", Toast.LENGTH_SHORT).show();
                    } else if (edtCompanyName.getText().toString().equalsIgnoreCase("")) {
                        Toast.makeText(ProfileActivitys.this, "Enter company name", Toast.LENGTH_SHORT).show();
                    } else if (edtAddress.getText().toString().equalsIgnoreCase("")) {
                        Toast.makeText(ProfileActivitys.this, "Enter address", Toast.LENGTH_SHORT).show();
                    } else if (edtState.getText().toString().equalsIgnoreCase("Select State")) {
                        Toast.makeText(ProfileActivitys.this, "Select State", Toast.LENGTH_SHORT).show();
                    } else if (edtCity.getText().toString().equalsIgnoreCase("Select city")) {
                        Toast.makeText(ProfileActivitys.this, "Select city", Toast.LENGTH_SHORT).show();
                    } else if (edtArea.getText().toString().equalsIgnoreCase("Select area")) {
                        Toast.makeText(ProfileActivitys.this, "Select area", Toast.LENGTH_SHORT).show();
                    } else if (edtCountry.getText().toString().equalsIgnoreCase("Select Country")) {
                        Toast.makeText(ProfileActivitys.this, "Enter country", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(ProfileActivitys.this, getString(R.string.internet_message), Toast.LENGTH_SHORT).show();
                }
        ...
        imgProfilePicDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.create(ProfileActivitys.this)
    ...
    public void contactMeDialog() {
        ...
        relPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(ProfileActivitys.this, Manifest.permission.CALL_PHONE)
                    ...
                    if (ActivityCompat.checkSelfPermission(ProfileActivitys.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void updateUserService() {
        ...
        requestParams.add("u_long", "00.00000");
        ...
        asyncHttpClient.post(ProfileActivitys.this, url, requestParams, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                // called when response HTTP status is "200 OK"
                Log.d("Success", statusCode + "" + responseBody);
                Toast.makeText(ProfileActivitys.this, getString(R.string.update_successfully), Toast.LENGTH_SHORT).show();
                String str = new String(responseBody);
                try {
                    JSONObject json = new JSONObject(str);
                    int status = json.getInt("status");
                    if (status == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (imagePath != null) {
                                Glide.with(ProfileActivitys.this).load(new File(imagePath)).centerCrop().bitmapTransform(new CropCircleTransformation(ProfileActivitys.this)).placeholder(R.drawable.avtar1).into(imgProfilePic);
                            } else {
                                Glide.with(ProfileActivitys.this).load(Textclass.profilePic + profileImage).centerCrop().bitmapTransform(new CropCircleTransformation(ProfileActivitys.this)).placeholder(R.drawable.avtar1).into(imgProfilePic);
                            }
                        ...
                        Toast.makeText(ProfileActivitys.this, getString(R.string.no_data), Toast.LENGTH_SHORT).show();
    ...
    private void setupViewPager(ViewPager viewPager) {
       ...
       specialityFragment=new SpecialityFragment();
        ...
        equipmentFragments=new EquipmentFragments();
        Bundle b = new Bundle();
        b.putString("screen", screen);
        b.putString("u_id", uId);
        equipmentFragments.setArguments(b);
        ...
        adapter.addFragment(equipmentFragments, "Equipment");
        adapter.addFragment(photosFragment, "Photo");
