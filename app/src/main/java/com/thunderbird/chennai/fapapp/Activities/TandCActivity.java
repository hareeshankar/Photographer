...
//
        ...
        itemProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TandCActivity.this, ProfileActivitys.class);
        ...
        itemSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TandCActivity.this, PhotographerListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        itemFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TandCActivity.this, FilterActivity.class);
                startActivity(intent);
                finish();
        ...
        itemInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TandCActivity.this, InfoActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        itemContactUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TandCActivity.this, FeedbackActivity.class);
                startActivity(intent);
                finish();
            }
        });
        itemExit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                android.support.v7.app.AlertDialog.Builder alertDialog = new android.support.v7.app.AlertDialog.Builder(TandCActivity.this).setMessage("Are you sure you want to logout?").setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        editor.clear();
                        editor.commit();
                        Intent intent = new Intent(TandCActivity.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
