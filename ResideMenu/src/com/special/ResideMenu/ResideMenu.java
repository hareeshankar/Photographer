...
public class ResideMenu extends FrameLayout {
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets insets) {
        ...
        int bottomPadding = viewActivity.getPaddingBottom() + insetsRect.bottom;

        Log.i("Bottom",""+bottomPadding);

        if (hasNavBar(Mycontext.getResources())) {
            bottomPadding += hasImmersive(activity);
            Log.i("Bottom1",""+bottomPadding);
            //  Toast.makeText(Mycontext,"Bottom height "+bottomPadding,Toast.LENGTH_SHORT).show();
        }

        this.setPadding(viewActivity.getPaddingLeft() + insetsRect.left,
                viewActivity.getPaddingTop() + insetsRect.top,
                viewActivity.getPaddingRight() + insetsRect.right,
                bottomPadding);
        insetsRect.left = insetsRect.top = insetsRect.right = insetsRect.bottom = 0;
    ...
    @SuppressLint("NewApi")
    public int hasImmersive(Context ctx) {
        ...
        android.view.Display d = ((WindowManager) activity.getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
        ...
        stringBuilder.append("Real Height =").append(""+realHeight).append("\n");
        stringBuilder.append("Real Width =").append(""+realWidth).append("\n\n");
        DisplayMetrics displayMetrics = new DisplayMetrics();
        d.getMetrics(displayMetrics);

        int displayHeight = displayMetrics.heightPixels;
        //   container.getLayoutParams().height=displayHeight;
        int displayWidth = displayMetrics.widthPixels;
        stringBuilder.append("Display Height =").append(""+displayHeight).append("\n");
        stringBuilder.append("Display Width =").append(""+displayWidth);
        // FindHeigh.setText(stringBuilder.toString());
